...
function Slider({
	...
	// Generate stable keys for thumbs based on array length
	const thumbKeys = React.useMemo(
		() =>
			Array.from({ length: _values.length }, (_, i) => `${thumbBaseId}-${i}`),
		[_values.length, thumbBaseId],
	);
